...
class ConfigEntrainement:
    ...
    # === ENVIRONNEMENT ===
    nb_environnements: int = 20  # Jeux parallèles
    ...
    epsilon_fin: float = 0
    epsilon_frames: int = 5000  # Steps de simulation pour atteindre epsilon_fin
    ...
    transitions_min_debut: int = (
        5_000  # Attendre ce nb de transitions avant le 1er update
    )
    eval_intervalle: int = 1000  # Éval toutes les N parties
